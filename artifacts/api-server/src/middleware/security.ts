...
export function securityHeaders(_req: Request, res: Response, next: NextFunction): void {
  ...
  res.setHeader(
    ...
    [
      "default-src 'self'",
      "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://www.google.com https://www.gstatic.com https://cdn.livechatinc.com https://secure.livechatinc.com",
      "style-src 'self' 'unsafe-inline' https://fonts.googleapis.com https://cdn.livechatinc.com",
      "font-src 'self' https://fonts.gstatic.com https://cdn.livechatinc.com",
      "img-src 'self' data: blob: https:",
      "connect-src 'self' https://api.coingecko.com wss: https://*.livechatinc.com wss://*.livechatinc.com",
      "frame-src 'self' https://www.google.com https://*.livechatinc.com",
      "object-src 'none'",
      "base-uri 'self'",
      "form-action 'self'",
