    ...
    <footer className="bg-[#0d0d0d]">
          ...
          <div className="flex-1 grid grid-cols-1 sm:grid-cols-3 gap-10">
            ...
            <div>
              ...
              <ul className="flex flex-col gap-3">
                ...
                <li>
                  <a href="mailto:info@guardiantrading.com" className="text-white text-[13px] transition-colors">
      ...
      <div className="max-w-[1100px] mx-auto px-6 py-8 text-center">
        ...
        <p className="text-[11px] text-white leading-relaxed mb-3 uppercase">
          ...
          <a href="https://brokercheck.finra.org" target="_blank" rel="noopener noreferrer" className="underline">FINRA'S BROKER CHECK</a>
          {" "}AND SEE THE VELOCITY CLEARING, LLC{" "}
          <a href="#" className="underline">RELATIONSHIP SUMMARY</a>.
        </p>
        <p className="text-[11px] text-white leading-relaxed mb-3 uppercase">
