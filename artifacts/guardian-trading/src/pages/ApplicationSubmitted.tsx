      ...
      <footer style={{ background: "#111" }}>
        ...
        <div className="px-5 sm:px-10 py-6 sm:py-8 text-center" style={{ paddingBottom: "calc(env(safe-area-inset-bottom, 0px) + 2rem)" }}>
          ...
          <p className="text-[11px] uppercase leading-relaxed" style={{ color: "#666", maxWidth: "900px", margin: "0 auto" }}>
            OPTIONS INVOLVE RISK AND ARE NOT SUITABLE FOR ALL INVESTORS. FOR MORE INFORMATION READ THE <a href="#" style={{ color: "#5baad4" }}>CHARACTERISTICS AND RISKS OF STANDARDIZED OPTIONS</a>, ALSO KNOWN AS THE OPTIONS DISCLOSURE DOCUMENT (ODD). ALTERNATIVELY, PLEASE CONTACT <a href="mailto:info@guardiiantrading.com" style={{ color: "#5baad4" }}>INFO@GUARDIIANTRADING.COM</a> TO RECEIVE A COPY OF THE ODD.
          </p>
        </div>
      </footer>
    </div>
