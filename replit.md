...
- **Rate limiting**: AI chat (20 req/min), file uploads (30 req/15min), auth endpoints (30 req/15min), global (100 req/min)
- **Input validation**: Profile update validates name format, phone format, and location format with regex before saving
