...
export default function AccountVerified() {
  ...
  return (
    <div className="min-h-screen flex flex-col overflow-x-hidden" style={{ background: "#f4f4f4" }}>
      ...
      <main className="flex-1 px-4 sm:px-6 py-6 sm:py-8 flex items-start justify-center">
        <div className="bg-white w-full max-w-2xl" style={{ borderRadius: "4px", boxShadow: "0 2px 12px rgba(0,0,0,0.10)", border: "1px solid #dde3e9" }}>
          ...
          <div className="px-6 sm:px-10 py-10 sm:py-12 flex flex-col items-center text-center">
            <div className="flex items-center justify-center rounded-full mb-6"
              style={{ width: "70px", height: "70px", background: "#e8f5e9", border: "3px solid #28a745" }}>
              <svg width="34" height="34" viewBox="0 0 24 24" fill="none" stroke="#28a745" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
            ...
            <h1 className="font-bold mb-3" style={{ fontSize: "22px", color: "#1c2e3e" }}>
            ...
            <button
              ...
              style={{ background: "#3a7bd5", color: "white", border: "none", borderRadius: "4px", padding: "12px 36px", fontSize: "14px", fontWeight: 700, cursor: "pointer" }}
            >
              Go to Dashboard
            </button>
          </div>
